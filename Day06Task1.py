# there might be an algorithm that gives the answer without working through the whole thing and 
# potentially getting stuck in an infinite loop, but that would need more effort than appropriate 
